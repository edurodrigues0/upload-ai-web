      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea
              ...
              placeholder="Inclua o propmt para IA..."
            />
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6" action="">
            <label 
              htmlFor="video"
              className="border flex aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5"
            >
              <FileVideo className="w-4 h-4" />
              Selecione um video
            </label>

            <input className="sr-only" type="file" id="video" accept="vide/mp4" />
